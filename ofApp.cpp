...
void ofApp::update() {
	...
	for (int z = 0; z < 900; z += 75) {
	
		int location_z = (z + ofGetFrameNum() * 2) % 900 * -1;
		this->setRingToMesh(this->face, this->frame, glm::vec3(0, 0, location_z), radius, 60, 20, 0, 360, ofColor(location_z > -450 ? 39 : ofMap(location_z, -450, -900, 39, 239)), ofColor(239));
	}
}
